...
public class DAO {
	...
	public boolean inserirUsuario(Usuario usuario) {
		...
		try {  
			...
			st.executeUpdate("INSERT INTO usuario (codigo, nome, telefone, email, senha) "
				       + "VALUES ("+usuario.getCodigo()+ ", '" + usuario.getNome() + "', '"  
				       + usuario.getTelefone() + "', '" + usuario.getEmail() + "', '" + usuario.getSenha() + "');");
			st.close();
			status = true;
	...
	public boolean atualizarUsuario(Usuario usuario) {
		...
		try {  
			Statement st = conexao.createStatement();
			String sql = "UPDATE usuario SET nome = '" + usuario.getNome() + "', telefone = '"  
				       + usuario.getTelefone() + "', Email = '" + usuario.getEmail() +  "', Senha = '"
				+ usuario.getSenha() + "'" + " WHERE codigo = " + usuario.getCodigo();
